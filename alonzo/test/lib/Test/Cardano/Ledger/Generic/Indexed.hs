...
scriptsize :: forall era. Fixed (Core.Script era) => Witness era -> Maybe Int
...
aScriptHashObj :: forall era kr. ValidateScript era => Witness era -> Core.Script era -> Credential kr (Crypto era)
...
pickValue :: forall era. Reflect era => Int -> Witness era -> (Value era)
...
pickScript :: Int -> Witness era -> Core.Script era
...
pickScriptHash :: forall era. Reflect era => Int -> Witness era -> ScriptHash (Crypto era)
pickScriptHash n wit = hashScript @era (pickScript n wit)

pickPolicyID :: Reflect era => Int -> Witness era -> Mary.PolicyID (Crypto era)
