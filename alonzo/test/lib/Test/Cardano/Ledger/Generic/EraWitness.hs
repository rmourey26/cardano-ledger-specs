...
module Test.Cardano.Ledger.Generic.EraWitness where
...
data Witness era where
  Shelley :: forall c. CC.Crypto c => Evidence c -> Witness (ShelleyEra c)
  Mary :: forall c. CC.Crypto c => Evidence c -> Witness (MaryEra c)
  Allegra :: forall c. CC.Crypto c => Evidence c -> Witness (AllegraEra c)
  Alonzo :: forall c. CC.Crypto c => Evidence c -> Witness (AlonzoEra c)
